...
$fileList = scandir($uploadsDirectory);
$fileList = array_diff($fileList, array('.', '..')); // Remove '.' and '..' from the file list
?>
...
<head>
    ...
    <style>
        ...
        .btn-primary {
            ...
            --bs-btn-active-border-color:#8f1111;
    ...
    <div class="container">
        ...
        <form action="take_attendance.php" method="post">
            <div class="form-group">
                ...
                <select class="form-select" id="fileSelect" name="file_selected">
