    ...
    <div class="container">
        <div class="form-box box">
            ...
            if (isset($_POST['update'])) {
                ...
                $id = $_SESSION['id'];
                $edit_query = mysqli_query($conn, "UPDATE admin SET username='$username', email='$email', password='$password' WHERE id = $id");

                if ($edit_query) {
                    echo "<div class='message'>
                <p>Profile Updated!</p>
                </div><br>";
                    echo "<a href='home_admin.php'><button class='btn'>Go Home</button></a>";
                }
            } else {

                $id = $_SESSION['id'];
                $query = mysqli_query($conn, "SELECT * FROM admin WHERE id = $id") or die("error occurs");
